...
const Icon: React.FC<IconProps> = ({ name, className = 'h-6 w-6' }) => {
  const icons: { [key in IconName]: JSX.Element } = {
    ...
    'users': (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.226A3 3 0 0018 15.75l-2.25-2.25a3 3 0 00-4.242 0-3 3 0 00-4.242 0L6 15.75a3 3 0 001.834 5.373m0-10.5a3 3 0 000-4.243A3 3 0 006 11.25a3 3 0 00-1.834-5.373m12 0c0 2.863-2.22 5.207-5.131 5.485A3 3 0 0012 15a3 3 0 00-2.869-2.275C6.22 12.485 4 10.141 4 7.278a3 3 0 002.131-5.373m12 0c2.863 0 5.207 2.22 5.485 5.131A3 3 0 0020 12a3 3 0 00-2.275 2.869c-.278 2.911-2.623 5.131-5.485 5.131a3 3 0 00-5.373-2.131m0 0a3 3 0 00-5.373 2.131" />
        </svg>
    ),
    'chart-bar': (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    'user-group': (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.226A3 3 0 0018 15.75l-2.25-2.25a3 3 0 00-4.242 0-3 3 0 00-4.242 0L6 15.75a3 3 0 001.834 5.373M3.75 4.5a3 3 0 00-3 3v1.5a3 3 0 003 3h1.5a3 3 0 003-3v-1.5a3 3 0 00-3-3h-1.5z" />
        </svg>
    ),
    'inbox': (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
